...
To change between branches, do `rm -rf ./*` before `git checkout` since git will not delete files for you. You might need to follow up with `git submodule update --init --recursive`.
